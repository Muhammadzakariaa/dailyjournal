...
// check jika belum ada user yang login arahkan ke halam login
 ...
 ?>
    ...
    <div class="container">
        ...
        <li class="nav-item">
            ...
            <li class="nav-items dropdown">
                <a class="user nav-link dropdown-toggle fw-bold" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <?= $_SESSION['username']?>
                </a>
    ...
    <section id="content" class="p-5">
        <div class="container"> 
            ...
            echo '<h4 class="lead display-6 pb-2 border-bottom border-success-subtle">' . $page . '</h4>';
            include($page . ".php");
            ?>
        </div> 
    </section>
    ...
    <footer class="text-center p-3">
			...
			<div>Muhammad Zakaria Putranto &copy; 2025</div>
    </footer>
    <!-- footer end -->
